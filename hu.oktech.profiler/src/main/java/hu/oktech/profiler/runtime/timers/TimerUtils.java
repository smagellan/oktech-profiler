...
/**
 * A Spring-compatible utility class to access the {@link TimerService}. The
...
public class TimerUtils {
	...
	private static TimerService service = new TimerServiceImpl();

	public static TimerService get() {
		return service;
	}

	public static void set(TimerService service_) {
		service = service_;
	}

	public void setService(TimerService service_) {
		service = service_;
	}
